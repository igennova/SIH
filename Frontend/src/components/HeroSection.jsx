...
function HeroSection() {
  return (
    ...
    >
      <div className="textstructure py-8">
        {["We Make Tools", "Deaf and Mute", "Community"].map((item, index) => (
            ...
            <div className="w-fit flex items-center overflow-hidden">
              {index === 1 && (
                <motion.div
                  ...
                  className="w-[8vw] h-[5vh] sm:h-[6vh] sm:w-[5vw] sm:mt-10 mr-5 flex justify-center items-center rounded-md bg-green-500"
                ></motion.div>
              )}
              <h1
                key={index}
